...
// // Arma el link a la ficha REAL en mercadopublico.cl. Ahí el usuario hace clic
// // en el ícono de adjuntos como lo haría cualquier persona -- por eso no hay
// // bloqueo anti-bots ni necesitamos descargar/guardar los archivos nosotros.
// function urlFichaMercadoPublico(codigoLicitacion) {
//     const base = "https://www.mercadopublico.cl/Procurement/Modules/RFB/DetailsAcquisition.aspx";
//     return `${base}?idlicitacion=${encodeURIComponent(codigoLicitacion)}`;
// }

// function VerAdjuntosLink({ codigoLicitacion }) {
//     return (
//         <a
//             href={urlFichaMercadoPublico(codigoLicitacion)}
//             target="_blank"
//             rel="noopener noreferrer"
//             className="btn btn-outline-secondary btn-sm"
//         >
//             Ver adjuntos en Mercado Público ↗
//         </a>
//     );
// }
...
//                                     <div className="mt-2">
//                                         <VerAdjuntosLink codigoLicitacion={item.CodigoExterno} />
//                                     </div>
...
//                     <VerAdjuntosLink codigoLicitacion={data.CodigoExterno || codigo} />
//                 </div>
//             )}
